 ...
 * dimension vectors.
 */
export type MultiplyUnits<Left extends MinimalUnit, Right extends MinimalUnit>
 ...
 * dimension vectors.
 */
export type DivideUnits<Left extends MinimalUnit, Right extends MinimalUnit>
    = MultiplyUnits<Left, ExponentiateUnit<Right, -1>>;
 ...
 */
export type ExponentiateUnit<Unit extends MinimalUnit, Power extends Exponent>
 ...
 */
type HandleErrors<Result extends ArithmeticResult>
    = true extends ResultHasError<Result> ? ArithmeticError : StripZeroes<RemoveErrors<Result>>;

type ResultHasError<Result> = {
    [D in keyof Result]: Result[D] extends ArithmeticError ? true : false;
}[keyof Result];
...
type ArithmeticResult = {
    [D in Dimension]: Exponent | ArithmeticError;
};
