 ...
 * dimension vectors.
 */
export type MultiplyUnits<Left extends MinimalDimensionVector, Right extends MinimalDimensionVector> = HandleErrors<
 ...
 */
export type ExponentiateUnit<Vector extends MinimalDimensionVector, Power extends Exponent> = HandleErrors<
...
export type NonZeroKeys<Vector extends MinimalDimensionVector> = {
...
export type FillZeroesImpl<Vector extends MinimalDimensionVector> = Vector & { [Dim in MissingDimensions<Vector>]: 0 };

export type MissingDimensions<Vector extends MinimalDimensionVector> = {
